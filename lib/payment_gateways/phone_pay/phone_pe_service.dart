...
class PhonePeServices {
  ...
  Future<void> createBodyAndCheckSum(num amount, String payType) async {
    try {
      ...
      Map<String, dynamic> requestBody = {
        ...
        "callbackUrl": callback, // Use the callback URL here
        "checksum": checkSum, // Include checksum in the body if needed
  ...
  Future<void> handlePayClick({bool isTypeCard = false}) async {
    ...
    Future<Map<dynamic, dynamic>?> response =
        PhonePePaymentSdk.startTransaction(body, packageName);
