...
class MidtransService {
  ...
  Future midtransPaymentCheckout() async {
    ...
    midpay.init(
      appConfigs.value.midtransPay.midtransClientId.validate(),
      kDebugMode
    ...
    var midtransTransaction = MidtransTransaction(
        totalAmount.toInt() /*100000*/, midtransCustomer, listitems,
        skipCustomer: true); //TODO: check
