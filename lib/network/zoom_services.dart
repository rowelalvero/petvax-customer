...
class ZoomServices {
  static Future<ZoomMeetingRes> generateZoomMeetingLink(
      {required String topic,
      required DateTime startTime,
      required int durationInMinuts}) async {
    ...
    String token = await generateJwt(appConfigs.value.zoom.clientId,
        appConfigs.value.zoom.clientSecret, appConfigs.value.zoom.accountId);
  ...
  static Future<String> generateJwt(
      String cId, String cSecret, String accId) async {
...
class ZoomMeetingRes {
  ...
  factory ZoomMeetingRes.fromJson(Map<String, dynamic> json) {
    return ZoomMeetingRes(
      ...
      h323Password:
          json['h323_password'] is String ? json['h323_password'] : "",
      pstnPassword:
          json['pstn_password'] is String ? json['pstn_password'] : "",
      encryptedPassword: json['encrypted_password'] is String
