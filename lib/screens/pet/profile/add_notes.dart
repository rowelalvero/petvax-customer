...
class AddNote extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return AppScaffold(
      appBartitleText:
          "${myPetsScreenController.selectedPetProfile.value.name}'${locale.value.sNotes}",
      actions: [
        GestureDetector(
          onTap: () {
                ...
                children: [
                  ...
                  AppTextField(
                    ...
                    decoration: inputDecoration(context,
                        hintText:
                            "${locale.value.eG}  ${locale.value.groomingFor} ${myPetsScreenController.selectedPetProfile.value.name} ",
                  ...
                  AppTextField(
                    title:
                        "${locale.value.noteFor} ${myPetsScreenController.selectedPetProfile.value.name}",
                    textStyle: primaryTextStyle(size: 12),
            ...
            child: AppButton(
              ...
              onTap: () {
                if (_noteformKey.currentState!.validate()) {
                  ...
                  if (!petProfileController.isLoading.value)
                    petProfileController.addEditNote();
                }
              },
            ),
          ),
    ...
    return Obx(
      () => ListTileTheme(
        ...
        child: CheckboxListTile(
          ...
          checkColor: white,
          title: Text(locale.value.setAsPrivateNote,
          ...
          onChanged: (value) {
            petProfileController.selectedNote.value.isPrivate(
                !petProfileController.selectedNote.value.isPrivate.value);
          },
        ),
