      ...
      child: AppScaffold(
        ...
        appBarTitle: Obx(
          () => Text(
            addPetInfoController.isUpdateProfile.value
                ? locale.value.editPetInfo
                : addPetInfoController
                    .pageViewElementList[addPetInfoController.currentPage.value]
                    .appBarTitle,
        ...
        body: Column(
          ...
          children: [
            ...
            Obx(
              () => StepsRow(
                isStep2Active: addPetInfoController
                    .pageViewElementList[addPetInfoController.currentPage.value]
                    .isStep2Active,
                isStep3Active: addPetInfoController
                    .pageViewElementList[addPetInfoController.currentPage.value]
                    .isStep3Active,
                midImg1: addPetInfoController
                    .pageViewElementList[addPetInfoController.currentPage.value]
                    .midImg1,
                midImg2: addPetInfoController
                    .pageViewElementList[addPetInfoController.currentPage.value]
                    .midImg2,
                ...
                return AnimatedScrollView(
                  ...
                  onNextPage: () async {
                    if (!addPetInfoController.isLastPage.value) {
                      addPetInfoController
                          .page(addPetInfoController.page.value + 1);
                    ...
                    Column(
                      ...
                      children: [
                        if (index == 0) ...[
                          Obx(
                            () => addPetInfoController
                                    .hasErrorFetchingbookingList.value
                                ? NoDataWidget(
                                    title:
                                        addPetInfoController.errorMessage.value,
                                    ...
                                    .paddingSymmetric(horizontal: 16)
                                : addPetInfoController.petTypeList.isEmpty &&
                                        !addPetInfoController.isLoading.value
                                    ? NoDataWidget(
                                        title: locale.value.itAppearsTheAdmin,
                                        imageWidget: const EmptyStateWidget(),
                                        subTitle: locale.value.youCanUtilizeThe,
                                        retryText:
                                            locale.value.sendRequestToAdmin,
                                        onRetry: () {
                                          Get.back();
                                        },
                                      ).paddingSymmetric(horizontal: 16)
