...
class ConfigurationResponse {
  ...
  factory ConfigurationResponse.fromJson(Map<String, dynamic> json) {
    return ConfigurationResponse(
      ...
      otpLoginStatus:
          json['otp_login_status'] is int ? json['otp_login_status'] : 0,
      siteDescription:
  ...
  Map<String, dynamic> toJson() {
    return {
      ...
      'midtrans_pay': midtransPay.toJson(),
      'cinet_pay': cinetPay.toJson(),
      'sadad_pay': sadadPay.toJson(),
      'zoom': zoom.toJson(),
  ...
  factory Phonepe.fromJson(Map<String, dynamic> json) {
    return Phonepe(
      ...
      phonepeMerchantId: json['phonepay_merchant_id'] is String
          ...
          : "",
      phonepeSaltKey:
          json['phonepay_salt_key'] is String ? json['phonepay_salt_key'] : "",
...
class MidtransPay {
  ...
  Map<String, dynamic> toJson() {
    return {
      'midtrans_client_key': midtransClientId,
    };
  }
}
...
class AirtelMoney {
  ...
  factory AirtelMoney.fromJson(Map<String, dynamic> json) {
    return AirtelMoney(
      airtelSecretkey:
          json['airtel_secretkey'] is String ? json['airtel_secretkey'] : "",
      airtelClientid:
