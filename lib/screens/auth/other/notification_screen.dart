      ...
      () => AppScaffold(
        ...
        actions: notificationScreenController.notificationDetail.isNotEmpty
            ? [
                TextButton(
                  onPressed: () {
                    notificationScreenController.clearAllNotification(
                        context: context);
                  },
                  child: Text(locale.value.clearAll,
                          ...
                          await Get.to(
                            ...
                            arguments: BookingDataModel(
                              ...
                              service: SystemService(
                                  slug: notification.data.notificationDetail
                                      .bookingServicesNames
                                      .toLowerCase()),
                      ...
                      children: [
                        Container(
                          ...
                          decoration: boxDecorationDefault(
                            color: notification.readAt.isNotEmpty
                          ...
                          child: Row(
                            ...
                            children: [
                              notification.data.notificationDetail
                                  ...
                                  : notification.data.notificationDetail
                                          .bookingServiceImage.isNotEmpty
                                      ? Container(
                                          decoration: boxDecorationDefault(
                                              color: Colors.white,
                                              shape: BoxShape.circle),
                              ...
                              Column(
                                ...
                                children: [
                                    ...
                                    children: [
                                      Text(
                                        notification.data.notificationDetail
                                                    .notificationGroup ==
                                                NotificationConst.shop
                                            ? '#${notification.data.notificationDetail.orderCode}'
                                            : '#${notification.data.notificationDetail.id}',
                                        style: primaryTextStyle(
                                            decoration: TextDecoration.none),
                                      ),
                                      4.width,
                                      Text('- ${notification.data.notificationDetail.bookingServicesNames}',
                                              style: primaryTextStyle())
                                  ...
                                  Text(
                                      ...
                                      .visible(notification.data
                                          .notificationDetail.type.isNotEmpty),
                                  4.height,
                                  Text(
                                      notification.createdAt
                                          .dateInddMMMyyyyHHmmAmPmFormat,
                                      style: secondaryTextStyle()),
                                ],
                              ),
                              const Spacer(),
