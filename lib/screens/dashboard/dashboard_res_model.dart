...
class DashboardData {
  ...
  factory DashboardData.fromJson(Map<String, dynamic> json) {
    return DashboardData(
      systemService: json['system_service'] is List
          ? List<SystemService>.from(
              json['system_service'].map((x) => SystemService.fromJson(x)))
          : [],
      slider: json['slider'] is List
          ? List<Slider>.from(json['slider'].map((x) => Slider.fromJson(x)))
          : [],
      petDaycareAmount: json['pet_daycare_amount'] is List
          ? List<PetDaycareAmount>.from(json['pet_daycare_amount']
              .map((x) => PetDaycareAmount.fromJson(x)))
          : [],
      petBoardingAmount: json['pet_boarding_amount'] is List
          ? List<PetBoardingAmount>.from(json['pet_boarding_amount']
              .map((x) => PetBoardingAmount.fromJson(x)))
          : [],
      taxPercentage: json['tax'] is List
          ? List<TaxPercentage>.from(
              json['tax'].map((x) => TaxPercentage.fromJson(x)))
          : [],
      event: json['event'] is List
          ? List<PetEvent>.from(json['event'].map((x) => PetEvent.fromJson(x)))
          : [],
      featuresProduct: json['featuresProduct'] is List
          ? List<ProductItemData>.from(
              json['featuresProduct'].map((x) => ProductItemData.fromJson(x)))
          : [],
      blog: json['blog'] is List
          ? List<Blog>.from(json['blog'].map((x) => Blog.fromJson(x)))
          : [],
      weightUnit: json['weight_unit'] is List
          ? List<UnitModel>.from(
              json['weight_unit'].map((x) => UnitModel.fromJson(x)))
          : [],
      heightUnit: json['height_unit'] is List
          ? List<UnitModel>.from(
              json['height_unit'].map((x) => UnitModel.fromJson(x)))
          : [],
      petSitter: json['pet_sitter'] is List
          ? List<PetSitterItem>.from(
              json['pet_sitter'].map((x) => PetSitterItem.fromJson(x)))
          : [],
      upcommingBooking: json['upcomming_booking'] is Map
          ? BookingDataModel.fromJson(json['upcomming_booking'])
          : BookingDataModel(
              service: SystemService(),
              payment: PaymentDetails(),
              training: Training()),
      notificationCount:
          json['notification_count'] is num ? json['notification_count'] : 0.0,
    );
  }
...
class PetEvent {
  ...
  factory PetEvent.fromJson(Map<String, dynamic> json) {
    return PetEvent(
      ...
      organizerName:
          json['organizer_name'] is String ? json['organizer_name'] : "",
      organizerEmail:
          json['organizer_email'] is String ? json['organizer_email'] : "",
      organizerContactNo: json['organizer_contact_no'] is String
          ? json['organizer_contact_no']
          : "",
      organizerImage:
          json['organizer_image'] is String ? json['organizer_image'] : "",
      description: json['description'] is String ? json['description'] : "",
      eventDateTime:
          json['event_date_time'] is String ? json['event_date_time'] : "",
