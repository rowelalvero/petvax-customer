...
class HomeServiceApis {
  ...
  static Future<StatusListRes> getAllStatusUsedForBooking(
      {List<String>? statusList}) async {
    return StatusListRes.fromJson(await handleResponse(await buildHttpResponse(
        APIEndPoints.bookingStatus,
        method: HttpMethodType.GET)));
  }

  static Future<PetCenterRes> getPetCenterDetail() async {
    return PetCenterRes.fromJson(await handleResponse(await buildHttpResponse(
        APIEndPoints.petCenterDetail,
        method: HttpMethodType.GET)));
  }
  ...
  static Future<List<Blog>> getBlog({
    ...
    final blogRes = BlogRes.fromJson(await handleResponse(
        await buildHttpResponse(
            "${APIEndPoints.getBlogs}?per_page=$perPage&page=$page",
            method: HttpMethodType.GET)));
  ...
  static Future<List<PetEvent>> getEvent({
    ...
    final eventRes = EventRes.fromJson(await handleResponse(
        await buildHttpResponse(
            "${APIEndPoints.getEvents}?per_page=$perPage&page=$page$lat$long",
            method: HttpMethodType.GET)));
  ...
  static Future<NotificationRes> getBlogsList() async {
    return NotificationRes.fromJson(await handleResponse(
        await buildHttpResponse(APIEndPoints.getNotification,
            method: HttpMethodType.GET)));
  }
}
