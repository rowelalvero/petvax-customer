  ...
  factory CartListResponse.fromJson(Map<String, dynamic> json) {
    return CartListResponse(
      ...
      data: json['data'] is List
          ...
          : [],
      cartPriceData: json['price'] is Map
          ? CartPriceData.fromJson(json['price'])
          : CartPriceData(taxData: CartTaxData()),
...
class CartListData {
  ...
  factory CartListData.fromJson(Map<String, dynamic> json) {
    return CartListData(
      ...
      productVariationId: json['product_variation_id'] is int
          ? json['product_variation_id']
          : -1,
      ...
      productDescription: json['product_description'] is String
          ...
          : "",
      discountValue:
          json['discount_value'] is num ? json['discount_value'] : -1,
      discountType:
          json['discount_type'] is String ? json['discount_type'] : "",
      productVariation: json['product_variation'] is Map
          ? VariationData.fromJson(json['product_variation'])
          : VariationData(inCart: false.obs),
      ...
      deliveredDate:
          json['delivered_date'] is String ? json['delivered_date'] : "",
      ...
      taxIncludeProductPrice: json['tax_include_product_price'] is num
          ...
          : -1,
      getProductPrice:
          json['get_product_price'] is num ? json['get_product_price'] : -1,
      productAmount:
          json['product_amount'] is num ? json['product_amount'] : -1,
      deliveryStatus:
      ...
      productReviewData: json['product_review'] is Map
          ? ProductReviewDataModel.fromJson(json['product_review'])
...
class CartPriceData {
  ...
  factory CartPriceData.fromJson(Map<String, dynamic> json) {
    return CartPriceData(
      taxIncludedAmount:
          json['tax_included_amount'] is num ? json['tax_included_amount'] : -1,
      discountAmount:
          json['discount_amount'] is num ? json['discount_amount'] : -1,
      totalAmount: json['total_amount'] is num ? json['total_amount'] : -1,
      taxData: json['tax_data'] is Map
          ? CartTaxData.fromJson(json['tax_data'])
          : CartTaxData(),
      taxAmount: json['tax_amount'] is num ? json['tax_amount'] : -1,
      totalPayableAmount: json['total_payable_amount'] is num
          ? json['total_payable_amount']
          : -1,
    );
  }
...
class CartTaxData {
  ...
  factory CartTaxData.fromJson(Map<String, dynamic> json) {
    return CartTaxData(
      ...
      taxDetails: json['tax_details'] is List
          ? List<TaxDetails>.from(
              json['tax_details'].map((x) => TaxDetails.fromJson(x)))
          : [],
    );
  }
