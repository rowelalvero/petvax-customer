                ...
                children: [
                  ...
                  Column(
                    ...
                    children: [
                        ...
                        children: [
                          ...
                          Container(
                            ...
                            decoration: boxDecorationDefault(
                                ...
                                border:
                                    Border.all(color: textSecondaryColorGlobal),
                            ...
                            child: IconButton(
                              ...
                              onPressed: () async {
                                ...
                                cartController.removeCart(
                                    context: context, cartId: cartListData.id);
                              },
                            ),
                          ),
                        ],
                      ...
                      ).visible(cartListData.soldBy.isNotEmpty &&
                          !(cartListData.soldBy == UNKNOWN)),
                      if (cartListData.productVariationValue.isNotEmpty)
                        Row(
                          children: [
                            Text('${cartListData.productVariationType}: ',
                                style: secondaryTextStyle()),
                            Text(
                    ...
                    child: Row(
                      ...
                      children: [
                            ...
                            if (cartController.isTap.value) {
                              if (cartListData.qty.value > 1) {
                                ...
                                cartController.updateCartAPi(
                                  ...
                                  productVariationId:
                                      cartListData.productVariationId,
                        ...
                        IconButton(
                          ...
                          onPressed: () async {
                            if (cartController.isTap.value) {
                              if (cartListData.qty.value <
                                  cartListData
                                      .productVariation.productStockQty) {
                                cartController.isTap(false);
                                cartListData.qty(cartListData.qty.value + 1);
                      ...
                      child: Row(
                        ...
                        children: [
                          if (!cartListData.isDiscount)
                            PriceWidget(
                              price: cartListData
                                  .productVariation.taxIncludeProductPrice,
                              size: 16,
                            ),
                          if (cartListData.isDiscount)
                            Row(
                              ...
                              children: [
                                PriceWidget(
                                    price: cartListData.productVariation
                                ...
                                if (cartListData.discountType ==
                                    TaxType.PERCENT)
                                  Text(
                                    '${cartListData.discountValue}%  ${locale.value.off}',
                                    style: primaryTextStyle(
                                        color: greenColor, size: 12),
                                  ).paddingLeft(8)
                                else if (cartListData.discountType ==
                                    TaxType.FIXED)
                                  PriceWidget(
