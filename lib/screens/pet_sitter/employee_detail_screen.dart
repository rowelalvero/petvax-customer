...
class EmployeeDetailScreen extends StatelessWidget {
  ...
  final EmployeeDetailController employeeDetailController =
                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          Row(
                            children: [
                              if (userDetail.data.profileImage
                                  .validate()
                                  .isNotEmpty)
                                CachedImageWidget(
                          ...
                          children: [
                            if (userDetail.data.aboutSelf.isNotEmpty)
                              Column(
                                crossAxisAlignment: CrossAxisAlignment.start,
                                children: [
                                  Text(locale.value.about,
                                      style: primaryTextStyle(size: 12)),
                                  8.height,
                                  Text(userDetail.data.aboutSelf,
                            ...
                            if (userDetail.data.expert.isNotEmpty)
                              Column(
                                crossAxisAlignment: CrossAxisAlignment.start,
                                children: [
                                  Text(locale.value.expertise,
                                      style: primaryTextStyle(size: 12)),
                                  8.height,
                                  Text(userDetail.data.expert,
                                      style: secondaryTextStyle()),
                                  16.height,
                                ],
                              ),
                            Text(locale.value.personalInfo,
                                style: primaryTextStyle(size: 12)),
                            TextIcon(
                              spacing: 10,
                              edgeInsets:
                              ...
                              Column(
                                ...
                                children: [
                                  ...
                                  Text("Facebook",
                                      style: primaryTextStyle(size: 12)),
                                  8.height,
                                  Text(userDetail.data.facebookLink,
                                      style: secondaryTextStyle()),
                                  16.height,
                                ],
                              ),
                              ...
                              Column(
                                ...
                                children: [
                                  Text("Instagram",
                                      style: primaryTextStyle(size: 12)),
                                  8.height,
                                  Text(userDetail.data.instagramLink,
                                      style: secondaryTextStyle()),
                                  16.height,
                                ],
                              ),
                              ...
                              Column(
                                ...
                                children: [
                                  Text("Twitter",
                                      style: primaryTextStyle(size: 12)),
                                  8.height,
                                  Text(userDetail.data.twitterLink,
                                      style: secondaryTextStyle()),
                                  16.height,
                                ],
                              ),
                              ...
                              Column(
                                ...
                                children: [
                                  Text("Dribbble",
                                      style: primaryTextStyle(size: 12)),
                                  8.height,
                                  Text(userDetail.data.dribbbleLink,
                                      style: secondaryTextStyle()),
                                  16.height,
                                ],
                              ),
                      ...
                      AppButton(
                        ...
                        onTap: () {
                          if (userDetail.data.mobile.isEmpty) {
                            toast(
                                "${userDetail.data.fullName} ${locale.value.hasNotSharedTheir}");
                          } else {
                            launchCall(userDetail.data.mobile);
                          }
                        },
                      ...
                      AppButton(
                        ...
                        onTap: () {
                          ...
                          if (userDetail.data.email.isEmpty) {
                            toast(
                                "${userDetail.data.fullName} ${locale.value.hasNotSharedTheirEmail}");
                          } else {
