...
class BookingCard extends StatelessWidget {
            ...
            child: Column(
              ...
              children: [
                    ...
                    children: [
                      Hero(
                        ...
                        child: Text(
                          '#${appointment.id}',
                          style:
                              primaryTextStyle(decoration: TextDecoration.none),
                        ),
                      ),
                    ],
                  ),
                ...
                Row(
                  mainAxisAlignment: MainAxisAlignment.center,
                  children: [
                    Text("${locale.value.bookingStatus}:",
                  ...
                  children: [
                    ...
                    SizedBox(
                      ...
                      child: Column(
                        children: [
                          ...
                          8.height,
                          Marquee(
                              child: Text(appointment.petName,
                    ...
                    Column(
                      ...
                      children: [
                        8.height,
                        detailWidget(
                            title: locale.value.schedule, value: scheduleDate),
                        detailWidgetPrice(
                            title: locale.value.price,
                            value: appointment.payment.totalAmount,
                            textColor: getPriceStatusColor(
                                paymentStatus:
                                    appointment.payment.paymentStatus)),
                        detailWidget(
                            title: locale.value.duration,
                            value: appointment.duration.toFormattedDuration(
                                showFullTitleHoursMinutes: true)),
                        detailWidget(
                          title: getEmployeeRoleByServiceElement(
                ...
                if (appointment.status.contains(BookingStatusConst.COMPLETED) &&
                    appointment.service.status.getBoolInt()) ...[
                  8.height,
                  AppButton(
                    width: Get.width,
                    ...
                    onTap: () async {
                      ...
                      await BookingServiceApis.getBookingDetail(
                              bookingId: appointment.id)
                          .then((value) {
                        bData = value.data;
                        navigateToService(appointment.service,
                            arguments: bData);
                      }).onError((error, stackTrace) {
                        toast(error.toString());
                      }).whenComplete(
                              () => bookingsController.isLoading(false));
                    },
                  ).paddingSymmetric(horizontal: 16),
                ],
                16.height,
                  ...
                  children: [
                    CachedImageWidget(
                      ...
                      color: secondaryColor,
                        ...
                        getServiceIconByServiceElement(appointment.service)
                            .isNotEmpty),
                    12.width,
                    Text(
  ...
  String get scheduleDate {
    try {
      return appointment.startDateTime.isValidDateTime
          ? appointment.startDateTime.dateInddMMMyyyyHHmmAmPmFormat
          : " - ";
    } catch (e) {
  ...
  Widget detailWidgetPrice(
      {required String title, required num value, Color? textColor}) {
    return Row(
      mainAxisAlignment: MainAxisAlignment.spaceBetween,
      children: [
        Marquee(
