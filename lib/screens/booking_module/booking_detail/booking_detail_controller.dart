...
class BookingDetailsController extends GetxController {
  ...
  Rx<Future<BookingDetailRes>> getBookingDetails = Future(() =>
      BookingDetailRes(
  ...
  Rx<BookingDataModel> bookingDetail = BookingDataModel(
          service: SystemService(),
          payment: PaymentDetails(),
          training: Training())
      .obs;
  ...
  deleteReview() async {
    isLoading(true);
    await BookingServiceApis.deleteReview(id: yourReview.value.id)
        .then((value) async {
      log('updateReview: ${value.toJson()}');
      toast(value.message);
      showWriteReview(false);
