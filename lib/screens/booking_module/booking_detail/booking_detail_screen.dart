...
class BookingDetailScreen extends StatelessWidget {
            ...
            onSuccess: (bookingDetailRes) {
              return AnimatedScrollView(
                ...
                children: [
                  Obx(
                    () => bookingController
                            .bookingDetail.value.service.id.isNegative
                        ? NoDataWidget(
                        ...
                        : Column(
                            ...
                            children: [
                              ...
                              Obx(() => bookingController
                                          .bookingDetail.value.petDetails !=
                                      null
                                  ? petInfoWidget(context)
                                  : const Offstage()),
                              ...
                              Obx(() => bookingController
                                      ...
                                      bookingController.bookingDetail.value
                                          .petDetails!.petNotes.isNotEmpty
                                  ? petNotes(context)
                                  : const Offstage()),
                              serviceInfoWidget(context).visible(
                                  bookingController
        ...
        Row(
          ...
          children: [
            ...
            SizedBox(
              ...
              child: TextButton(
                style: ButtonStyle(
                    backgroundColor: WidgetStatePropertyAll(lightPrimaryColor2),
                    padding: const WidgetStatePropertyAll(EdgeInsets.zero)),
                onPressed: () {
                  myPetsScreenController.selectedPetProfile(
                      bookingController.bookingDetail.value.petDetails!);
                  Get.to(() => PetProfileScreen());
                },
                child: Text(locale.value.seePetProfile,
        ...
        Obx(
          () => AnimatedListView(
            ...
            itemCount: bookingController
                .bookingDetail.value.petDetails!.petNotes.reversed
                .take(2)
                .length,
            listAnimationType: ListAnimationType.FadeIn,
            physics: const NeverScrollableScrollPhysics(),
            itemBuilder: (BuildContext contex, index) {
              NotePetModel notePetModel = bookingController
                  .bookingDetail.value.petDetails!.petNotes.reversed
                  .toList()[index];
                            ...
                            children: [
                              Row(
                                children: [
                                  CachedImageWidget(
                                    url:
                                        notePetModel.createdbyUser.profileImage,
                                    height: 22,
                                    width: 22,
                                    circle: true,
                                    radius: 22,
                                  ...
                                  12.width,
                                  Text(notePetModel.createdbyUser.userName,
                                      style: secondaryTextStyle()),
                                ],
                              ),
                            ],
                          ).paddingBottom(16),
                          Text(notePetModel.title,
                              textAlign: TextAlign.left,
                              style: primaryTextStyle()),
                          8.height,
                          Text(notePetModel.description,
                              textAlign: TextAlign.left,
                              style: secondaryTextStyle()),
                        ],
      ...
      children: [
              ...
              child: TextButton(
                ...
                onPressed: () {
                  handleRescheduleClick(
                      context: context,
                      isLoading: bookingController.isLoading,
                      bookingDetail: bookingController.bookingDetail);
                },
                child: Text(locale.value.reschedule,
                        style: secondaryTextStyle(color: primaryColor))
                    .paddingSymmetric(horizontal: 8, vertical: 2),
              ),
            ).visible(bookingController.bookingDetail.value.status
        ...
        Container(
          ...
          child: Column(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              if (bookingController.bookingDetail.value.service.slug
                  .contains(ServicesKeyConst.boarding)) ...[
                detailWidget(
                    title: locale.value.dropOffDate,
                    value: bookingController
                            .bookingDetail.value.dropoffDateTime.isValidDateTime
                        ? bookingController.bookingDetail.value.dropoffDateTime
                ...
                detailWidget(
                    ...
                    value: bookingController
                            .bookingDetail.value.pickupDateTime.isValidDateTime
                        ? bookingController.bookingDetail.value.pickupDateTime
                            .dateInDMMMMyyyyFormat
                        : ""),
                detailWidget(
              ...
              if (bookingController.bookingDetail.value.service.slug
                ...
                detailWidget(
                    ...
                    value: bookingController
                            .bookingDetail.value.dayCareDate.isValidDateTime
                        ? bookingController.bookingDetail.value.dayCareDate
                            .dateInDMMMMyyyyFormat
                        : ""),
                detailWidget(
                  title: locale.value.dropOffTime,
                  value: bookingController
                          .bookingDetail.value.dropoffTime.isValidTime
                ...
                detailWidget(
                  title: locale.value.pickupTime,
                  value: bookingController
                          .bookingDetail.value.pickupTime.isValidTime
              ...
              if (!(bookingController.bookingDetail.value.service.slug
                      .contains(ServicesKeyConst.boarding) ||
                  bookingController.bookingDetail.value.service.slug
                      .contains(ServicesKeyConst.dayCare))) ...[
                detailWidget(
                    title: locale.value.date,
                    value: bookingController
                            .bookingDetail.value.serviceDateTime.isValidDateTime
                        ? bookingController.bookingDetail.value.serviceDateTime
                            .dateInDMMMMyyyyFormat
                        : ""),
                detailWidget(
              ...
              detailWidget(
                  ...
                  value: bookingController.bookingDetail.value.food.isNotEmpty
                      ? bookingController.bookingDetail.value.food.first
                      : ""),
              detailWidget(
                  title: locale.value.favoriteActivity,
                  value:
                      bookingController.bookingDetail.value.activity.isNotEmpty
                          ? bookingController.bookingDetail.value.activity.first
                          : ""),
              detailWidget(
                  title: locale.value.reason,
                  value:
                      bookingController.bookingDetail.value.veterinaryReason),
              detailWidget(
                  title: locale.value.service,
                  value: bookingController
                      .bookingDetail.value.veterinaryServiceName),
              detailWidget(
                  title: locale.value.bookingStatus,
                  value: getBookingStatus(
                      status: bookingController.bookingDetail.value.status),
              ...
              detailWidget(
                  ...
                  value: getBookingPaymentStatus(
                      status: bookingController
                          .bookingDetail.value.payment.paymentStatus
              ...
              detailWidget(
                  ...
                  value: bookingController.bookingDetail.value.duration
  ...
  Widget paymentDetails(BuildContext context) {
    return Column(
      ...
      children: [
        32.height,
        Text(locale.value.paymentDetails, style: primaryTextStyle())
            .paddingSymmetric(horizontal: 16),
        8.height,
        Container(
          padding: const EdgeInsets.only(left: 16, right: 16, top: 16),
            ...
            children: [
              ...
              ...List.generate(
                ...
                (index) => detailWidgetPrice(
                  title:
                      '${bookingController.bookingDetail.value.payment.taxs[index].title} ${(bookingController.bookingDetail.value.payment.taxs[index].title == "Sales Tax" || bookingController.bookingDetail.value.payment.taxs[index].title == "Other Taxes") && bookingController.bookingDetail.value.payment.taxs[index].taxType == "percentage" ? "( ${bookingController.bookingDetail.value.payment.taxs[index].taxValue}%" : bookingController.bookingDetail.value.payment.taxs[index].taxType == "fixed" ? "( \$${bookingController.bookingDetail.value.payment.taxs[index].taxValue}" : bookingController.bookingDetail.value.payment.taxs[index].taxValue} )',
                  value: bookingController
                      .bookingDetail.value.payment.taxs[index].value,
                  textColor: isDarkMode.value
              ...
              detailWidgetPrice(
                ...
                value:
                    bookingController.bookingDetail.value.payment.totalAmount,
                textColor: getPriceStatusColor(
                    paymentStatus: bookingController
                        .bookingDetail.value.payment.paymentStatus),
              ),
  ...
  Widget employeeInfoWidget(BuildContext context) {
    return Column(
      ...
      children: [
        32.height,
        Text(locale.value.employeeInformation, style: primaryTextStyle())
            .paddingSymmetric(horizontal: 16),
        8.height,
        Container(
          padding: const EdgeInsets.only(left: 16, right: 16, top: 16),
                  ...
                  GestureDetector(
                    onTap: () {
                      Get.to(() => EmployeeDetailScreen(),
                          arguments:
                              bookingController.bookingDetail.value.employeeId);
                    },
                    behavior: HitTestBehavior.translucent,
                    child: Row(
                      children: [
                        ...
                        8.width,
                        Text(bookingController.bookingDetail.value.employeeName,
                            style: primaryTextStyle(size: 12)),
                      ],
                    ).visible(bookingController.bookingDetail.value.employeeName
                        .trim()
                        .isNotEmpty),
                  ).paddingBottom(8),
                  detailWidget(
                      title: locale.value.designation,
                      value: getEmployeeRoleByServiceElement(
                          appointment: bookingController.bookingDetail.value)),
                  detailWidget(
                          title: locale.value.contactNumber,
                          value: bookingController
                              .bookingDetail.value.employeeContact)
                      .onTap(() {
                    launchCall(
                        bookingController.bookingDetail.value.employeeContact);
                  }),
                  detailWidget(
                          title: locale.value.email,
                          value: bookingController
                              .bookingDetail.value.employeeEmail)
                      .onTap(() {
                    launchMail(
                        bookingController.bookingDetail.value.employeeEmail);
                  }),
                ],
              ),
              6.height,
  ...
  Widget petInfoWidget(BuildContext context) {
    return Column(
      ...
      children: [
        32.height,
        Text(locale.value.petInformation, style: primaryTextStyle())
            .paddingSymmetric(horizontal: 16),
        8.height,
        Container(
          padding: const EdgeInsets.only(left: 16, right: 16, top: 16),
          ...
          child: Column(
            ...
            children: [
              ...
              Column(
                ...
                children: [
                  detailWidget(
                      title: locale.value.breed,
                      value: bookingController
                          .bookingDetail.value.petDetails!.breed),
                  detailWidget(
                      title: locale.value.gender,
                      value: bookingController
                          .bookingDetail.value.petDetails!.gender
                          .capitalizeFirstLetter()),
                  if (bookingController
                          .bookingDetail.value.petDetails!.weight !=
                      0)
                    detailWidget(
                      title: locale.value.weight,
                      value:
                          "${bookingController.bookingDetail.value.petDetails!.weight} ${bookingController.bookingDetail.value.petDetails!.weightUnit}",
                    ),
                  if (bookingController
                          .bookingDetail.value.petDetails!.height !=
                      0)
                    detailWidget(
                      title: locale.value.height,
                      value:
                          "${bookingController.bookingDetail.value.petDetails!.height} ${bookingController.bookingDetail.value.petDetails!.heightUnit}",
                    ),
                ],
              ),
            ],
  ...
  Widget serviceInfoWidget(BuildContext context) {
    return Column(
      ...
      children: [
        32.height,
        Text(locale.value.serviceInformation, style: primaryTextStyle())
            .paddingSymmetric(horizontal: 16),
        8.height,
        Container(
          padding:
  ...
  Widget additionalInfoWidget(BuildContext context) {
    return Column(
      ...
      children: [
        32.height,
        Text(locale.value.additionalInformation, style: primaryTextStyle())
            .paddingSymmetric(horizontal: 16),
        8.height,
        Container(
          padding:
