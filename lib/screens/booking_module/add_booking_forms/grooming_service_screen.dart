...
class GroomingScreen extends StatelessWidget {
            ...
            child: Stack(
              children: [
                ...
                Obx(() => const LoaderWidget()
                    .center()
                    .visible(groomingController.isLoading.value))
              ],
            ),
          )
        : AppScaffold(
                      ...
                      children: [
                        ...
                        ChooseYourPet(
                          onChanged: (selectedPet) {
                            groomingController.bookGroomingReq.petId =
                                selectedPet.id;
                          },
                        ),
                        32.height,
                        ...
                        Obx(
                          () => AppTextField(
                            ...
                            onTap: () async {
                              serviceCommonBottomSheet(
                                ...
                                child: BottomSelectionSheet(
                                  ...
                                  isEmpty: !groomingController
                                          .isLoading.value &&
                                      groomingController.serviceList.isEmpty,
                                  errorText: groomingController
                            ...
                            decoration: inputDecoration(context,
                                ...
                                prefixIcon: groomingController.selectedService
                                ...
                                suffixIcon: groomingController.selectedService
                          ...
                          () => Column(
                            children: [
                              AppTextField(
                                ...
                                readOnly: true,
                                onTap: () async {
                                  if (groomingController.groomerList.length ==
                                          1 &&
                                      groomingController.selectedService.value
                                              .createdBy ==
                                          groomingController
                                              .groomerList.first.id) {
                                    //
                                  } else {
                                        ...
                                        () => BottomSelectionSheet(
                                          ...
                                          isEmpty: !groomingController
                                              ...
                                              groomingController
                                                  .groomerList.isEmpty,
                                          errorText: groomingController
                                              .errorMessageGroomer.value,
                                          noDataTitle:
                                              locale.value.groomerListIsEmpty,
                                          noDataSubTitle:
                                              locale.value.thereAreNoGroomers,
                                          isLoading:
                                              groomingController.isLoading,
                                          searchApiCall: (p0) {
                                ...
                                decoration: inputDecoration(
                                  ...
                                  prefixIcon: groomingController.selectedGroomer
                                      ...
                                      : CachedImageWidget(
                                          ...
                                          bottom: 8,
                                          right: 12),
                                  suffixIcon: !groomingController
                                          .selectedService
                                          .value
                                          .createdBy
                                          .isNegative
                                      ? const Offstage()
                                      : groomingController.selectedGroomer.value
                              ...
                              Text(
                                ...
                                style: secondaryTextStyle(size: 10),
                                  ...
                                  .visible(!groomingController.selectedService
                  ...
                  onTap: () async {
                    if (groomingController.dateCont.text.trim().isEmpty) {
                      ...
                      TimeOfDay? pickedTime = await showTimePicker(
                        initialTime: TimeOfDay.fromDateTime(groomingController
                            .bookGroomingReq.time.dateInHHmm24HourFormat),
  ...
  Widget grommingServiceListWid(List<ServiceModel> list) {
    return AnimatedListView(
      ...
      onNextPage: () {
        if (!groomingController.isLastPage.value) {
          groomingController.page++;
          groomingController.isLoading(true);
          groomingController.getService();
        }
      },
      onSwipeRefresh: () async {
        groomingController.page(1);
        groomingController.getService();
