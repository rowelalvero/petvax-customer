...
class VeterineryServiceScreen extends StatelessWidget {
                  ...
                  onTap: () async {
                    if (veterineryController.dateCont.text
                      ...
                      TimeOfDay? pickedTime = await showTimePicker(
                        initialTime: TimeOfDay.fromDateTime(veterineryController
                            .bookVeterinaryReq.time.dateInHHmm24HourFormat),
  ...
  Widget veterinaryTypeListWid(List<ShopCategoryModel> list) {
    return AnimatedListView(
      ...
      onNextPage: () {
        if (!veterineryController.isLastPage.value) {
          veterineryController.page++;
          veterineryController.isLoading(true);
          veterineryController.getCategory();
        }
      },
      onSwipeRefresh: () async {
        veterineryController.page(1);
        veterineryController.getCategory();
