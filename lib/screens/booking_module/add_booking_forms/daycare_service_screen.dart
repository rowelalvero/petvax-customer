            ...
            child: Stack(
              children: [
                ...
                Obx(() => const LoaderWidget()
                    .center()
                    .visible(dayCareServiceController.isLoading.value))
              ],
            ),
          )
        : AppScaffold(
                      ...
                      children: [
                        ...
                        Obx(
                          () => AppTextField(
                            ...
                            controller:
                                dayCareServiceController.daycareTakerCont,
                              ...
                              serviceCommonBottomSheet(context,
                                  child: Obx(
                                    () => BottomSelectionSheet(
                                      ...
                                      isLoading:
                                          dayCareServiceController.isLoading,
                                      noDataTitle:
                                          locale.value.daycareTakerListIsEmpty,
                                      noDataSubTitle:
                                          locale.value.thereAreNoDaycare,
                                      searchApiCall: (p0) {
                                        dayCareServiceController
                                            .getDayCareTakers(searchtext: p0);
                                      },
                                      onRetry: () {
                                        dayCareServiceController
                                            .getDayCareTakers();
                        ...
                        AppTextField(
                          ...
                          minLines: 5,
                          controller:
                              dayCareServiceController.additionalInfoCont,
                          // focus: editUserProfileController.addressFocus,
                          decoration: inputDecoration(context,
      ...
      itemBuilder: (context, index) {
        return SettingItemWidget(
          ...
          onTap: () {
            ...
            dayCareServiceController.bookDayCareReq.price =
                dayCareServiceController
                    .selectedDayCareTaker.value.oneDayAmount;
            dayCareServiceController.isRefresh(true);
            dayCareServiceController.isRefresh(false);
            dayCareServiceController.isRefresh(true);
    ...
    return AppTextField(
      ...
      onTap: () async {
        DateTime? selectedDate = await showDatePicker(
          context: context,
          initialDate: dayCareServiceController
                  .bookDayCareReq.date.dateInyyyyMMddHHmmFormat
