...
class WalkingServiceScreen extends StatelessWidget {
  ...
  WalkingServiceScreen({super.key, this.isFromReschedule = false});
            ...
            child: Stack(
              children: [
                ...
                Obx(() => const LoaderWidget()
                    .center()
                    .visible(walkingServiceController.isLoading.value))
              ],
            ),
          )
        : AppScaffold(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Obx(
                          () => AppTextField(
                            ...
                            decoration: inputDecoration(
                              ...
                              prefixIcon: walkingServiceController
                                          .selectedWalker
                                          .value
                                          .profileImage
                                          .isEmpty &&
                              ...
                              suffixIcon: walkingServiceController
                                          .selectedWalker
                                          .value
                                          .profileImage
                                          .isEmpty &&
                              ...
                              serviceCommonBottomSheet(
                                ...
                                child: Obx(
                                  () => BottomSelectionSheet(
                                    ...
                                    isEmpty: !walkingServiceController
                                            .isLoading.value &&
                                        walkingServiceController
                                            .walkerList.isEmpty,
                                    ...
                                    isLoading:
                                        walkingServiceController.isLoading,
                                    noDataTitle: locale.value.walkerListIsEmpty,
                                    noDataSubTitle:
                                        locale.value.thereAreNoWalkers,
                                    searchApiCall: (p0) {
                        ...
                        AppTextField(
                          ...
                          minLines: 5,
                          controller:
                              walkingServiceController.additionalInfoCont,
                ...
                Obx(
                  () => AppButtonWithPricing(
                    ...
                    onTap: () {
                      if (_walkingformKey.currentState!.validate()) {
                        _walkingformKey.currentState!.save();
                        if (walkingServiceController.selectedDuration.value.id >
                                0 &&
                    ...
                    if (walkingServiceController.dateCont.text.trim().isEmpty) {
                      ...
                      TimeOfDay? pickedTime = await showTimePicker(
                        initialTime: TimeOfDay.fromDateTime(
                            walkingServiceController
                                .bookWalkingReq.time.dateInHHmm24HourFormat),
                              ...
                              decoration: boxDecorationDefault(
                                color: walkingServiceController
                                    ...
                                    ? isDarkMode.value
                                        ...
                                        : lightPrimaryColor
                                    : context.cardColor,
                                border: walkingServiceController
                                            .selectedDuration.value ==
                                        durationList[index]
                                    ? Border.all(
      ...
      itemBuilder: (context, index) {
        return SettingItemWidget(
          ...
          onTap: () {
            ...
            walkingServiceController.getWalker();
            walkingServiceController.getDurationList(
                employeeId: walkingServiceController.selectedWalker.value.id,
                isBooking: 1);
            walkingServiceController.showBookBtn(false);
            Get.back();
          },
