...
class TrainingServiceScreen extends StatelessWidget {
  ...
  TrainingServiceScreen({Key? key, this.isFromReschedule = false})
      : super(key: key);
            ...
            child: Stack(
              children: [
                ...
                Obx(() => const LoaderWidget()
                    .center()
                    .visible(trainingController.isLoading.value))
              ],
            ),
          )
        : AppScaffold(
                      ...
                      children: [
                        ...
                        ChooseYourPet(
                          onChanged: (selectedPet) {
                            trainingController.bookTrainingReq.petId =
                                selectedPet.id;
                          },
                        ),
                        32.height,
                        ...
                        Obx(
                          () => AppTextField(
                              ...
                              serviceCommonBottomSheet(
                                ...
                                child: Obx(
                                  () => BottomSelectionSheet(
                                    ...
                                    hasError: trainingController
                                        .hasErrorFetchingTrainer.value,
                                    isEmpty: !trainingController
                                            .isLoading.value &&
                                        trainingController.trainerList.isEmpty,
                                    errorText: trainingController
                                        .errorMessageTrainer.value,
                                    isLoading: trainingController.isLoading,
                                    noDataTitle:
                                        locale.value.trainerListIsEmpty,
                                    noDataSubTitle:
                                        locale.value.thereAreNoTrainers,
                                    searchApiCall: (p0) {
                            ...
                            decoration: inputDecoration(
                              ...
                              prefixIcon: trainingController.selectedTrainer
                                          .value.profileImage.isEmpty &&
                                      trainingController
                                          .selectedTrainer.value.id.isNegative
                                  ? null
                                  : CachedImageWidget(
                                      url: trainingController.selectedTrainer
                              ...
                              suffixIcon: trainingController.selectedTrainer
                                          .value.profileImage.isEmpty &&
                                      trainingController
                                          .selectedTrainer.value.id.isNegative
                                  ? Icon(
                              ...
                              .visible(!trainingController.isRefresh.value),
                        ),
                        32.height,
                        AppTextField(
                            ...
                            serviceCommonBottomSheet(context,
                                child: Obx(
                                  () => BottomSelectionSheet(
                                    ...
                                    hasError: trainingController
                                        .hasErrorFetchingTraining.value,
                                    isEmpty: !trainingController
                                            .isLoading.value &&
                                        trainingController.trainingList.isEmpty,
                                    errorText: trainingController
                                        .errorMessageTraining.value,
                                    isLoading: trainingController.isLoading,
                                    noDataTitle:
                                        locale.value.trainingListIsEmpty,
                                    noDataSubTitle:
                                        locale.value.thereAreNoTraining,
                                    searchApiCall: (p0) {
                                    ...
                                    listWidget: Obx(() => trainingListWid(
                ...
                Obx(
                  () => AppButtonWithPricing(
                    ...
                    onTap: () {
                      ...
                      .paddingSymmetric(horizontal: 16)
                      .visible(trainingController.showBookBtn.value),
                ),
              ],
            ),
          );
  ...
  Widget trainingListWid(List<TrainingModel> list) {
    return AnimatedListView(
      ...
      itemBuilder: (context, index) {
        TrainingModel trainingData = list[index];
        ...
        return Column(
          children: [
            SettingItemWidget(
              ...
              subTitle: (trainingData.createdBy ==
                      trainingController.selectedTrainer.value.id)
                  ? '${locale.value.providedBy} ${trainingController.selectedTrainer.value.fullName}'
                  : locale.value.providedByAdmin,
              subTitleTextStyle: secondaryTextStyle(
                  color: primaryColor, fontStyle: FontStyle.italic),
              onTap: () {
                trainingController.selectedTraining(trainingData);
                trainingController.trainingCont.text =
                    trainingController.selectedTraining.value.name;
                trainingController.isShowTrainingDuration(true);
                trainingController.getTrainingDurationList(
                    trainingTypeId:
                        trainingController.selectedTraining.value.id);
      ...
      onNextPage: () {
        if (!trainingController.isLastPage.value) {
          trainingController.page++;
          trainingController.isLoading(true);
          trainingController.getTraining(
            employeeId: trainingController.selectedTrainer.value.id,
            isBooking: 1,
          );
        }
      },
      onSwipeRefresh: () async {
        trainingController.page(1);
        trainingController.getTraining(
          employeeId: trainingController.selectedTrainer.value.id,
          isBooking: 1,
      ...
      itemBuilder: (context, index) {
        return SettingItemWidget(
          ...
          onTap: () {
            ...
            trainingController.trainerCont.text =
                trainingController.selectedTrainer.value.fullName;
            ...
            trainingController.getTraining(
                employeeId: trainingController.selectedTrainer.value.id,
                isBooking: 1);
            trainingController.isShowTrainingDuration(false);
            Get.back();
          },
        );
      },
                ...
                AppTextField(
                  ...
                  onTap: () async {
                    ...
                    if (selectedDate != null) {
                      trainingController.bookTrainingReq.date =
                          selectedDate.formatDateYYYYmmdd();
                      trainingController.dateCont.text =
                  ...
                  onTap: () async {
                    if (trainingController.dateCont.text.trim().isEmpty) {
                      ...
                      TimeOfDay? pickedTime = await showTimePicker(
                        initialTime: TimeOfDay.fromDateTime(trainingController
                            .bookTrainingReq.time.dateInHHmm24HourFormat),
                        //TODO: Make Time Extension
                        context: context,
                      );

                      if (pickedTime != null) {
                        if ("${trainingController.bookTrainingReq.date} ${pickedTime.formatTimeHHmm24Hour()}"
                            .isAfterCurrentDateTime) {
                          trainingController.bookTrainingReq.time =
                              pickedTime.formatTimeHHmm24Hour();
                          trainingController.timeCont.text =
  ...
  Widget durationWidget() {
                          ...
                          () => InkWell(
                            ...
                            child: Container(
                              ...
                              decoration: boxDecorationDefault(
                                color:
                                    trainingController.selectedDuration.value ==
                                            durationList[index]
                                        ? isDarkMode.value
                                            ? darkGrayGeneral2
                                            : lightPrimaryColor
    ...
    ).paddingTop(32).visible(trainingController.isShowTrainingDuration.value);
  }
}
