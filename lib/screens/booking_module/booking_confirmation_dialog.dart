    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          16.height,
          Text(titleText ?? locale.value.confirmBooking,
              style: primaryTextStyle()),
          16.height,
          Text(subTitleText ?? locale.value.doYouConfirmThisBooking,
          ...
          Row(
            ...
            children: [
              AppButton(
                ...
                color:
                    isDarkMode.value ? lightPrimaryColor2 : lightSecondaryColor,
                onTap: () {
                  Get.back();
                },
              ).expand(),
                ...
                onTap: () {
                  if (hideAgree) {
                    ...
                    if (isAgree.value) {
                      ...
                      toast(changeToastMessage ??
                          locale.value.pleaseAcceptTermsAnd);
                    }
                  }
                },
              ).expand(),
