...
class BookingDataModel {
  ...
  factory BookingDataModel.fromJson(Map<String, dynamic> json) {
    final paymentObj = PaymentDetails(
      taxs: json['taxes'] is List
          ? List<Taxs>.from(json['taxes'].map((x) => Taxs.fromJson(x)))
          : [],
    ...
    return BookingDataModel(
      ...
      service: json['service'] is Map
          ? SystemService.fromJson(json['service'])
          : SystemService(),
      ...
      employeeEmail:
          json['employee_email'] is String ? json['employee_email'] : "",
      employeeContact:
          json['employee_contact'] is String ? json['employee_contact'] : "",
      ...
      veterinaryServiceName:
          json['service_name'] is String ? json['service_name'] : "",
      ...
      food: json['food'] is List
          ? List<String>.from(json['food'].map((x) => x))
          : [],
      activity: json['activity'] is List
          ? List<String>.from(json['activity'].map((x) => x))
          : [],
      dropoffDateTime:
          json['dropoff_date_time'] is String ? json['dropoff_date_time'] : "",
      dropoffAddress:
          json['dropoff_address'] is String ? json['dropoff_address'] : "",
      pickupDateTime:
          json['pickup_date_time'] is String ? json['pickup_date_time'] : "",
      pickupAddress:
          json['pickup_address'] is String ? json['pickup_address'] : "",
      medicalReport:
          json['medical_report'] is String ? json['medical_report'] : "",
      startVideoLink:
          json['start_video_link'] is String ? json['start_video_link'] : "",
      joinVideoLink:
          json['join_video_link'] is String ? json['join_video_link'] : "",
      additionalFacility: json['additional_facility'] is List
          ? List<FacilityModel>.from(
              json['additional_facility'].map((x) => FacilityModel.fromJson(x)))
          : [],
      ...
      training: json['training'] is Map
          ...
          : Training(),
      petDetails: json['pet_details'] is Map
          ? PetData.fromJson(json['pet_details'])
          : PetData(),
    );
  }
  ...
  factory PaymentDetails.fromJson(Map<String, dynamic> json) {
    return PaymentDetails(
      ...
      discountPercentage: json['discount_percentage'] is num
          ...
          : 0.0,
      discountAmount:
          json['discount_amount'] is num ? json['discount_amount'] : 0.0,
...
class Taxs {
  ...
  factory Taxs.fromJson(Map<String, dynamic> json) {
    return Taxs(
      ...
      taxValue: json['tax_value'] is num ? json['tax_value'] : 0.0,
