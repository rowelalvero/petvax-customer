  ...
  factory EmployeeModel.fromJson(Map<String, dynamic> json) {
    return EmployeeModel(
      ...
      distance: json['distance'] is String
          ? double.tryParse(json['distance'].toString().replaceAll(",", "")) ??
              0
          : json['distance'] is num
              ? json['distance']
              : 0,
      profileImage: json['profile_image'] is String
          ? (json['profile_image'] as String).obs
          : "".obs,
      oneDayAmount: json['one_day_amount'] is num ? json['one_day_amount'] : 0,
    );
  }
