          ...
          child: Column(
            ...
            children: [
              Stack(
                ...
                children: [
                  Container(
                    ...
                    child: Image.asset(
                        Assets.imagesVector4), //TODO replace this vector
                  ),
                  Container(
                    height: 80,
                    width: 80,
                    alignment: Alignment.center,
                    decoration: boxDecorationDefault(
                        shape: BoxShape.circle, color: bookingVerifyColor),
              ...
              SizedBox(
                width: Get.width * 0.8,
                child: Text(
                  saveBookingRes.value.bookingId.isNegative
                      ? locale.value.yourPetAppointmentIs
                      : "${locale.value.yourBookingIdIs} #${saveBookingRes.value.bookingId}${locale.value.eWillBe}.",
                  textAlign: TextAlign.center,
              ...
              Obx(
                () => Container(
                  ...
                  child: Row(
                    ...
                    crossAxisAlignment: CrossAxisAlignment.center,
                    children: [
                      Assets.iconsIcTimeOutlined.iconImage(
                          color: Colors.white, size: 15, fit: BoxFit.contain),
                      8.width,
                      Text(
                          bookingSuccessDate
                              .value.dateInEEEEDMMMMAtHHmmAmPmFormat,
                          style:
                ...
                () => TextButton(
                  onPressed: () {
                    ...
                    DateTime eventDateTime =
                        bookingSuccessDate.value.dateInyyyyMMddHHmmFormat;
                    String description =
                        "${getServiceNameByServiceElement(serviceSlug: currentSelectedService.value.slug)}-#${saveBookingRes.value.bookingId}";
                    addToGoogleCalendar(
                            title: "$APP_NAME ${locale.value.booking}",
