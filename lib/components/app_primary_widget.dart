...
class AppPrimaryWidget extends StatefulWidget {
  ...
  }) : assert(gradiantOpacity >= 0.0 || gradiantOpacity <= 1.0,
            "Gradiant opacity should be 0.0 or more Or 1.0 or less");

  @override
  State<AppPrimaryWidget> createState() => _AppPrimaryWidgetState();
}

class _AppPrimaryWidgetState extends State<AppPrimaryWidget>
